...
from app import db
from app.database.models import Film, Actor
...
def populate_films():
    ...
    harry_potter_and_ch_s = Film(
        ...
        description='An ancient prophecy seems to be coming true when a mysterious presence begins stalking \
            the corridors of a school of magic and leaving its victims paralyzed.',
        distributed_by='Warner Bros. Pictures',
        length=161,
        rating=7.4,
    )
    harry_potter_and_priz_az = Film(
        ...
        description='Harry Potter, Ron and Hermione return to Hogwarts School of Witchcraft \
            and Wizardry for their third year of study, where they delve into the mystery surrounding \
                an escaped prisoner who poses a dangerous threat to the young wizard.',
        distributed_by='Warner Bros. Pictures',
        length=142,
        rating=7.9,
    )
    harry_potter_and_ph_goblet_fire = Film(
        ...
        description='Harry Potter finds himself competing in a hazardous tournament between rival schools \
    ...
    harry_potter_and_order_phoenix = Film(
        ...
        description='With their warning about Lord Voldemort\'s (Ralph Fiennes\') return scoffed at,\
            Harry (Daniel Radcliffe) and Dumbledore (Sir Michael Gambon) are targeted by the Wizard authorities \
    ...
    harry_potter_and_half_blood_prince = Film(
        ...
        description='As Harry Potter (Daniel Radcliffe) begins his sixth year at Hogwarts, he discovers \
            an old book marked as "the property of the Half-Blood Prince" and begins to learn more about\
                Lord Voldemort\'s (Ralph Fiennes\') dark past.',
        distributed_by='Warner Bros. Pictures',
        length=153,
        rating=7.6,
    )
    harry_potter_and_deathly_hallows_1 = Film(
        ...
        description='As Harry (Daniel Radcliffe), Ron (Rupert Grint), and Hermione (Emma Watson) race against \
            time and evil to destroy the Horcruxes, they uncover the existence of the three most powerful objects \
    ...
    harry_potter_and_deathly_hallows_2 = Film(
        ...
        description='Harry, Ron, and Hermione search for Voldemort\'s remaining Horcruxes in their effort \
    ...
    harry_potter_and_half_blood_prince.actors = [daniel_radcliffe, emma_watson, rupert_grint, michael_gambon, alan_rickman]
    harry_potter_and_deathly_hallows_1.actors = [daniel_radcliffe, emma_watson, rupert_grint, michael_gambon, alan_rickman]
    harry_potter_and_deathly_hallows_2.actors = [daniel_radcliffe, emma_watson, rupert_grint, michael_gambon, alan_rickman]
