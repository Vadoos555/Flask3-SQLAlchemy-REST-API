...
class PopulateDB(Resource):
    ...
    def post(self):
        ...
        print(f'Done in {end.total_seconds():.2f} sec.')
        return {'message': f'Database was populated with {created_films} films'}
    ...
    def get_films_urls(self):
        ...
        film_containers = soup.find_all('td', class_='posterColumn')
        film_links = [film.a.attrs['href'] for film in film_containers][:10]
        return film_links
